...
function App() {
  ...
  const [gbpPost, setGbpPost] = useState({ summary: "", ctaUrl: "", ctaType: "LEARN_MORE" });
  ...
  const submitGbpPost = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setGbpPost({ summary: "", ctaUrl: "", ctaType: "LEARN_MORE" });
                    ...
                    <div style={styles.table}>
                      ...
                      {monthlyQueue.map(row => (
                        ...
                        >
                          ...
                          <div style={{ flex: 1, textAlign: "center" }}>
                            <span style={{ fontSize: 11, padding: "3px 10px", borderRadius: 20, border: "1px solid", color: row.source === "gap" ? "#f59e0b" : "#60a5fa", background: row.source === "gap" ? "rgba(245,158,11,0.1)" : "rgba(96,165,250,0.1)", borderColor: row.source === "gap" ? "rgba(245,158,11,0.2)" : "rgba(96,165,250,0.2)" }}>
                              {row.source === "gap" ? "Gap" : "Library"}
                            </span>
                          </div>
                          <div style={{ flex: 1, textAlign: "center" }}>
